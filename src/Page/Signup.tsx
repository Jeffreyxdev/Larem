...
import FormControlLabel from "@mui/material/FormControlLabel"; // For labels with checkboxes/radios
...
// For toast notifications (Snackbar in MUI)
import Snackbar from '@mui/material/Snackbar';
import MuiAlert, {type  AlertProps } from '@mui/material/Alert'; // For a more styled toast

// Original Google Button
import GoogleButton from 'react-google-button';

// Helper for MuiAlert - allows it to be used within Snackbar
...
const SignUpForm = () => {
  ...
  return (    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-white/90 via-green-100 to-green-800">
      ...
      {/* Planetary elements */}
      <div className="absolute top-20 right-20 w-32 h-32 bg-gradient-to-br from-green-400 to-green-600 rounded-full opacity-80 blur-sm animate-pulse"></div>
      ...
      <Box className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl">
        ...
        <Box className="mb-6">
          <GoogleButton
            ...
            // Note: GoogleButton has its own styling. MUI Button would be different.
            style={{
              width: '99%',
              borderRadius: '22px',
              fontSize: '16px',
        ...
        <Box className="flex mb-6 bg-white/5 rounded-xl p-1">
          <Button
            ...
            // Apply custom styling via sx prop or className to match original design
            sx={{
              flexGrow: 1,
              display: 'flex',
              alignItems: 'center',
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          ...
          <Box className="grid grid-cols-2 gap-3">
            <FormControl fullWidth>
              <InputLabel shrink htmlFor="firstName" sx={{ color: 'rgba(255,255,255,0.8)', fontSize: '14px', transform: 'translate(0, -9px) scale(1)' }}> {/* Adjusted transform for better label position */}
                First Name
              </InputLabel>
              <TextField
                id="firstName"
                ...
                required
                variant="filled" // Use filled variant for background
                InputProps={{ // Styling for the input element itself
                  ...
                  sx: {
                    ...
                    '& .MuiInputBase-input::placeholder': { // Target placeholder
                ...
                sx={{
                  '& .MuiFilledInput-root': {
                    border: '1px solid rgba(255,255,255,0.2)', // Border matching original
                    '&:hover:not(.Mui-disabled):before': {
                        borderBottom: 'none', // Remove hover underline
                    },
                    '&:after': { // Remove focus underline
                        borderBottom: 'none',
                    },
                    '&:before': { // Remove default underline
                        borderBottom: 'none',
                    }
                  }
                }}
          ...
          <FormControlLabel
            control={
              <Checkbox
                ...
                sx={{
                  ...
                  '&.Mui-checked': {
                    color: 'rgba(255,255,255,0.5)', // Checked fill color
                    backgroundColor: 'rgba(255,255,255,0.2)', // Background when checked
                  },
                  '& .MuiSvgIcon-root': {
                    ...
                    height: '20px',
                    '& path': { // Hide default checkmark and use the parent SVG styling
                        d: 'path("M0 0h24v24H0z")' // Makes it essentially an empty path
                    }
                  },
                  '& .MuiTouchRipple-root': {
            ...
            sx={{
                // Adjust margin if needed to align with label
                '& .MuiFormControlLabel-label': {
                    marginLeft: '4px' // Adjust space between checkbox and label
                }
            }}
          />
          ...
          <Button
            ...
            sx={{
              backgroundColor: 'rgba(255,255,255,0.15)', // bg-blue-600
              '&:hover': {
                backgroundColor: 'rgba(255,255,255,0.15)', // hover:bg-blue-700
        ...
        <Typography variant="body2" className="text-center mt-6 text-white/60 text-sm">
          ...
          <Button
            component="span" // Render as span for text, but keep button behavior
            ...
            sx={{
              ...
              textTransform: 'none',
              verticalAlign: 'baseline', // Align with text
            }}
          >
            Sign In
          </Button>
